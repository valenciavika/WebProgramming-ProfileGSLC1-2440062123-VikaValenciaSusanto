        ...
        @section('judul_halaman', 'PROFILE JJB')        
        @section('konten')
        <div class="flex justify-center bg-slate-100">
            <button type="button" onclick="window.location='{{ url("friend/4") }}'" class="p-4 m-2 text3 font-serif text-white bg-slate-700 rounded-full">
