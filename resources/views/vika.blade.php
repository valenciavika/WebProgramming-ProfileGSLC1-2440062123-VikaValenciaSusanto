<!DOCTYPE html>
    ...
    @section('judul_halaman', 'PROFILE VVS')        
    @section('konten')
        <div class="flex justify-center bg-gray-100">
            <button type="button" onclick="window.location='{{ url("friend/1") }}'" class="p-4 m-2 text3 font-serif text-white bg-gray-700 rounded-full">
